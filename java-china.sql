...
insert  into `t_node`(`nid`,`pid`,`title`,`description`,`slug`,`pic`,`topics`,`create_time`,`is_del`) values (1,0,'站务管理','站务管理','affair',NULL,3,1457933734,0),(2,1,'程序发布','','release',NULL,1,1457933734,0);
...
CREATE TABLE `t_topic` (
  ...
  `loves` int(10) NOT NULL DEFAULT '0' COMMENT '获得点赞数',
...
insert  into `t_user`(`uid`,`login_name`,`pass_word`,`following`,`notices`,`topics`,`comments`,`avatar`,`email`,`create_time`,`update_time`,`role_id`,`status`) values (1,'biezhi','26b2010cd2028d742b283da54a304584',0,0,0,0,'default/4.png','',1410944818,1410944818,1,1),(13,'wangjue','880d2c4f88de0c111e4a14a2e93cbccf',0,0,3,0,'default/2.png','921293209@qq.com',1458573501,1458573501,5,1);
