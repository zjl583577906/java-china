...
# Database: java-china
# Generation Time: 2016-04-02 17:18:05 +0000
# ************************************************************
...
VALUES
	...
	(2,0,1,'程序发布','','release',NULL,1,1457933734,0,0),
...
CREATE TABLE `t_topic` (
  ...
  `title` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT '帖子标题',
...
INSERT INTO `t_user` (`uid`, `login_name`, `pass_word`, `following`, `notices`, `topics`, `comments`, `avatar`, `email`, `create_time`, `update_time`, `role_id`, `status`)
VALUES
	(1,'biezhi','26b2010cd2028d742b283da54a304584',0,0,9,0,'avatar/biezhi.png','biezhi.me@gmail.com',1410944818,1410944818,1,1),
	(13,'wangjue','880d2c4f88de0c111e4a14a2e93cbccf',0,0,6,0,'avatar/wangjue.png','921293209@qq.com',1458573501,1458573501,5,1),
	(14,'jobs','65e7b35f7ae3a0a23e13745dcb0ffa57',0,0,2,0,'avatar/jobs.png','',0,0,5,1);
...
INSERT INTO `t_userinfo` (`uid`, `nick_name`, `web_site`, `github`, `signature`, `instructions`)
VALUES
	(1,'王爵','https://biezhi.me',NULL,'这个人有点懒,还没写签名','...');
