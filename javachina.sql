...
# Database: javachina
# Generation Time: 2016-04-09 17:42:07 +0000
# ************************************************************
...
CREATE TABLE `t_topic` (
  ...
  `is_chosen` tinyint(2) DEFAULT '0' COMMENT '是否精选',
...
INSERT INTO `t_topic` (`tid`, `uid`, `nid`, `title`, `content`, `views`, `favorites`, `loves`, `comments`, `is_top`, `is_chosen`, `create_time`, `update_time`, `status`)
VALUES
	(1,1,2,'Hello Java China!','Java China的第一个帖子！',38,0,1,0,0,0,1457933734,1457933734,1),
	...
	(12,13,6,'如何看待麦当劳新推出的叫号排队系统？','之前麦当劳点餐之后是直接配餐，如果你要一杯可乐，点餐的同时已经在给你准备了，付款后很快就能给你端上来。 \r\n而现在新推出的银行式叫号系统，点餐后给你一个序号单，必须按屏幕上的叫号顺序一个个取餐。哪怕你只点了一丁点东西，也要等前面点了很多东西的人上完餐才能领餐。我认为这无形中降低了上餐的效率，也浪费了顾客的等待时间。大家怎么看呢？',145,0,1,3,0,0,1459615677,1459953557,1),
	...
	(14,14,10,'如何搭建spring框架','下面，我将用两种方式来讲述如何搭建Spring环境，其中第一种是利用MyEclipse工具里自带的来自动配置Spring，第二种事由我们自己手动配置，有什么区别么，没有什么太大的区别，第一种稍微简单，第二种稍微复杂，但是第二种方式能配置较高版本的Spring，大家看个人爱好了！',9,0,0,0,0,1,1459616454,1460220355,1),
	(15,1,9,'如果你现在有1000万你准备干什么？','rt：只是假如。。。',44,0,1,0,0,0,1459616515,1460217789,1),
	(16,1,11,'如何爬取最新的电影资讯呢？','使用java',54,0,1,0,0,0,1459616551,1459616551,1),
