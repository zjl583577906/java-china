...
# Database: javachina
# Generation Time: 2016-04-10 12:05:48 +0000
# ************************************************************
...
VALUES
	...
	(11,13,8,'可能是东半球最好的文字游戏吧! 一玩就停不下来!','\r\n[http://g.miaowu.asia/index.php?lang=cn ](http://g.miaowu.asia/index.php?lang=cn )\r\n\r\n\r\n加入了存档系统。 \r\n\r\n双击可以自动采集资源 \r\n\r\n(游戏是开源的 我只是优化跟加入存档系统,并且保证它一直存在下去，已经开了1年多了)',8,1,1,0,0,1,1459615649,1459615649,1),
	(12,13,6,'如何看待麦当劳新推出的叫号排队系统？','之前麦当劳点餐之后是直接配餐，如果你要一杯可乐，点餐的同时已经在给你准备了，付款后很快就能给你端上来。 \r\n而现在新推出的银行式叫号系统，点餐后给你一个序号单，必须按屏幕上的叫号顺序一个个取餐。哪怕你只点了一丁点东西，也要等前面点了很多东西的人上完餐才能领餐。我认为这无形中降低了上餐的效率，也浪费了顾客的等待时间。大家怎么看呢？',191,1,1,3,0,1,1459615677,1460236350,1),
	...
	(14,14,10,'如何搭建spring框架','下面，我将用两种方式来讲述如何搭建Spring环境，其中第一种是利用MyEclipse工具里自带的来自动配置Spring，第二种事由我们自己手动配置，有什么区别么，没有什么太大的区别，第一种稍微简单，第二种稍微复杂，但是第二种方式能配置较高版本的Spring，大家看个人爱好了！',159,0,1,0,0,0,1459616454,1460220355,1),
	(15,1,9,'如果你现在有1000万你准备干什么？','rt：只是假如。。。',70,1,1,0,0,0,1459616515,1460235571,1),
...
VALUES
	(1,'王爵','Web Dev!','https://biezhi.me','biezhi','上海','这个人有点懒,还没写签名','...');
