...
MySQL - 5.6.14-log : Database - javachina
*********************************************************************
*/
...
insert  into `t_activecode`(`id`,`uid`,`code`,`type`,`is_use`,`expires_time`,`create_time`) values (3,13,'u0ZWmxmZwoIV1EdtjOVxYVSXEFqrBz9f','signup',1,1458577101,1458573501),(5,13,'KF8ESHQdXxNDr1s8K4yMtfZzp5zjLeXR','forgot',0,1458660613,1458657013),(6,13,'U0dXQqVDMZOjpcRI10bztWJ5OZao1GqL','forgot',0,1458660782,1458657182);
...
insert  into `t_comment`(`cid`,`uid`,`to_uid`,`tid`,`content`,`create_time`) values (1,1,1,7,'没有人解答吗，在线等',1459525310);
...
insert  into `t_favorite`(`id`,`type`,`uid`,`event_id`,`create_time`) values (4,'topic',1,16,1459758841);
...
/*Data for the table `t_love` */

insert  into `t_love`(`id`,`uid`,`tid`) values (8,1,1),(10,1,16),(12,1,15);
...
insert  into `t_node`(`nid`,`uid`,`pid`,`title`,`description`,`slug`,`pic`,`topics`,`create_time`,`update_time`,`is_del`) values (1,1,0,'站务管理','站务管理','affair','node/affair.png',3,1457933734,1459596711,0),(2,0,1,'程序发布','','release',NULL,1,1457933734,0,0),(3,1,0,'分享与探索','','fenxiang','',0,1459519131,1459519131,0),(4,1,0,'生活','','life','',0,1459519169,1459519169,0),(5,1,0,'Java','','java','',0,1459519176,1459519176,0),(6,1,3,'问与答','','qna','',3,1459519199,1459519199,0),(7,1,3,'分享发现','','share','',3,1459519229,1459519229,0),(8,1,3,'分享创造','','create','',2,1459519247,1459519247,0),(9,1,3,'奇思妙想','','ideas','',1,1459519266,1459519266,0),(10,1,5,'Spring','','spring','node/spring.png',3,1459519278,1459617072,0),(11,1,5,'爬虫','','spiders','',1,1459519288,1459519288,0),(12,1,0,'招聘','','jobs','',0,1459524976,1459524976,0),(13,1,12,'酷工作','','cool','',1,1459524995,1459524995,0);
...
insert  into `t_settings`(`skey`,`svalue`) values ('comment_count','2'),('site_description','JavaChina是一个使用Blade框架开发的Java简洁论坛程序'),('site_keywords','Java社区,Blade框架,程序员论坛,开源程序'),('site_title','Java中国'),('topic_count','18'),('user_count','2');
...
insert  into `t_user`(`uid`,`login_name`,`pass_word`,`following`,`notices`,`topics`,`comments`,`avatar`,`email`,`create_time`,`update_time`,`role_id`,`status`) values (1,'biezhi','26b2010cd2028d742b283da54a304584',0,0,9,0,'avatar/biezhi.png','biezhi.me@gmail.com',1410944818,1410944818,1,1),(13,'wangjue','880d2c4f88de0c111e4a14a2e93cbccf',0,0,6,0,'avatar/wangjue.png','921293209@qq.com',1458573501,1458573501,5,1),(14,'jobs','65e7b35f7ae3a0a23e13745dcb0ffa57',0,0,2,0,'avatar/jobs.png','',0,0,5,1);
...
insert  into `t_userinfo`(`uid`,`nick_name`,`jobs`,`web_site`,`github`,`signature`,`instructions`) values (1,'王爵',NULL,'https://biezhi.me',NULL,'这个人有点懒,还没写签名','...');
